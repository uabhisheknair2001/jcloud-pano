...
!(function (t) {
  ...
  return (function () {
  ...
  })()(
    {
      1: [
        function (e, i, r) {
          !(function (e, r, n) {
            ...
            function t(t) {
              ...
              /opera/i.test(t)
                ...
                ? ((n = {
                  ...
                  x
                    ? ((n.msedge = s), (n.version = x))
                    : ((n.msie = s),
                      (n.version = e(/iemobile\/(\d+(\.\d+)?)/i))))
                ...
                : /edg([ea]|ios)/i.test(t)
                ? (n = { name: "Microsoft Edge", msedge: s, version: x })
                : /vivaldi/i.test(t)
                ? (n = {
                    name: "Vivaldi",
                    vivaldi: s,
                ...
                ? ((n = {
                  ...
                  /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t) &&
                    ((n.firefoxos = s), (n.osname = "Firefox OS")))
                : p
                ? (n = {
                    name: "Amazon Silk",
                    silk: s,
                ...
                ? ((n = {
                  ...
                  /touchpad\//i.test(t) && (n.touchpad = s))
                : /bada/i.test(t)
                ? (n = {
                    name: "Bada",
                    osname: "Bada",
                ...
                : l
                ? (n = { name: "Android", version: w })
                : /safari|applewebkit/i.test(t)
                ? ((n = { name: "Safari", safari: s }), w && (n.version = w))
                : o
                ? ((n = {
                    name:
                ...
                !n.msedge && /(apple)?webkit/i.test(t)
                  ? (/(apple)?webkit\/537\.36/i.test(t)
                      ? ((n.name = n.name || "Blink"), (n.blink = s))
                      : ((n.name = n.name || "Webkit"), (n.webkit = s)),
                    !n.version && w && (n.version = w))
                  : !n.opera &&
                    /gecko\//i.test(t) &&
                    ((n.name = n.name || "Gecko"),
                    (n.gecko = s),
                    (n.version = n.version || e(/gecko\/(\d+(\.\d+)?)/i))),
                n.windowsphone || (!l && !n.silk)
                  ? !n.windowsphone && o
                    ? ((n[o] = s), (n.ios = s), (n.osname = "iOS"))
                    : y
                    ? ((n.mac = s), (n.osname = "macOS"))
                    : S
                    ? ((n.xbox = s), (n.osname = "Xbox"))
                    : _
                    ? ((n.windows = s), (n.osname = "Windows"))
                    : g && ((n.linux = s), (n.osname = "Linux"))
                  : ((n.android = s), (n.osname = "Android"));
              var E = "";
              n.windows
                ? (E = (function (t) {
                    switch (t) {
                ...
                : n.windowsphone
                ? (E = e(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i))
                : n.mac
                ? ((E = e(/Mac OS X (\d+([_\.\s]\d+)*)/i)),
                  (E = E.replace(/[_\s]/g, ".")))
                : o
                ? ((E = e(/os (\d+([_\s]\d+)*) like mac os x/i)),
                  (E = E.replace(/[_\s]/g, ".")))
                : l
                ? (E = e(/android[ \/-](\d+(\.\d+)*)/i))
                : n.webos
                ? (E = e(/(?:web|hpw)os\/(\d+(\.\d+)*)/i))
                : n.blackberry
                ? (E = e(/rim\stablet\sos\s(\d+(\.\d+)*)/i))
                : n.bada
                ? (E = e(/bada\/(\d+(\.\d+)*)/i))
                : n.tizen && (E = e(/tizen[\/\s](\d+(\.\d+)*)/i)),
                E && (n.osversion = E);
              ...
              return (
                ...
                (n.whale && 1 === r([n.version, "1.0"])) ||
                (n.mzbrowser && 1 === r([n.version, "6.0"])) ||
                (n.focus && 1 === r([n.version, "1.0"])) ||
            ...
            function r(t) {
              for (
                var r = Math.max(e(t[0]), e(t[1])),
                  n = i(t, function (t) {
                    var n = r - e(t);
                    return (
                      (t += new Array(n + 1).join(".0")),
      ...
      2: [
        function (t, e, i) {
          (i.glMatrix = t("./gl-matrix/common.js")),
            (i.mat2 = t("./gl-matrix/mat2.js")),
            (i.mat2d = t("./gl-matrix/mat2d.js")),
            (i.mat3 = t("./gl-matrix/mat3.js")),
            (i.mat4 = t("./gl-matrix/mat4.js")),
            (i.quat = t("./gl-matrix/quat.js")),
            (i.vec2 = t("./gl-matrix/vec2.js")),
            (i.vec3 = t("./gl-matrix/vec3.js")),
            (i.vec4 = t("./gl-matrix/vec4.js"));
        },
        {
      ...
      3: [
        function (t, e, i) {
          ...
          (r.EPSILON = 1e-6),
            ...
            (r.ENABLE_SIMD = !1),
            (r.SIMD_AVAILABLE =
              r.ARRAY_TYPE === this.Float32Array && "undefined" != typeof SIMD),
          ...
          (r.toRadian = function (t) {
            ...
            (r.equals = function (t, e) {
              return (
                Math.abs(t - e) <=
                r.EPSILON * Math.max(1, Math.abs(t), Math.abs(e))
              );
            }),
            (e.exports = r);
        },
        ...
        function (t, e, i) {
          ...
          (n.create = function () {
            ...
            (n.adjoint = function (t, e) {
              var i = e[0];
              return (
                (t[0] = e[3]), (t[1] = -e[1]), (t[2] = -e[2]), (t[3] = i), t
              );
            }),
            ...
            (n.equals = function (t, e) {
              ...
              return (
                ...
                Math.abs(o - h) <=
                  r.EPSILON * Math.max(1, Math.abs(o), Math.abs(h)) &&
                Math.abs(s - u) <=
                  r.EPSILON * Math.max(1, Math.abs(s), Math.abs(u))
              );
            }),
        ...
        function (t, e, i) {
          ...
          (n.create = function () {
            ...
            (n.equals = function (t, e) {
              ...
              return (
                Math.abs(i - h) <=
                  r.EPSILON * Math.max(1, Math.abs(i), Math.abs(h)) &&
                Math.abs(n - u) <=
                  r.EPSILON * Math.max(1, Math.abs(n), Math.abs(u)) &&
                Math.abs(o - c) <=
                  r.EPSILON * Math.max(1, Math.abs(o), Math.abs(c)) &&
                Math.abs(s - p) <=
                  r.EPSILON * Math.max(1, Math.abs(s), Math.abs(p)) &&
                Math.abs(a - d) <=
                  r.EPSILON * Math.max(1, Math.abs(a), Math.abs(d)) &&
                Math.abs(l - f) <=
        ...
        function (t, e, i) {
          ...
          (n.create = function () {
            ...
            (n.equals = function (t, e) {
              ...
              return (
                Math.abs(i - p) <=
                  r.EPSILON * Math.max(1, Math.abs(i), Math.abs(p)) &&
                Math.abs(n - d) <=
                  r.EPSILON * Math.max(1, Math.abs(n), Math.abs(d)) &&
                Math.abs(o - f) <=
                  r.EPSILON * Math.max(1, Math.abs(o), Math.abs(f)) &&
                Math.abs(s - m) <=
                  r.EPSILON * Math.max(1, Math.abs(s), Math.abs(m)) &&
                Math.abs(a - v) <=
                  r.EPSILON * Math.max(1, Math.abs(a), Math.abs(v)) &&
                Math.abs(l - _) <=
                  r.EPSILON * Math.max(1, Math.abs(l), Math.abs(_)) &&
                Math.abs(h - y) <=
                  r.EPSILON * Math.max(1, Math.abs(h), Math.abs(y)) &&
                Math.abs(u - g) <=
                  r.EPSILON * Math.max(1, Math.abs(u), Math.abs(g)) &&
                Math.abs(c - x) <=
                  r.EPSILON * Math.max(1, Math.abs(c), Math.abs(x))
              );
            }),
            (e.exports = n);
        },
          ...
          (n.create = function () {
            ...
            (n.SIMD.transpose = function (t, e) {
              ...
              return (
                ...
                (n = SIMD.Float32x4.load(e, 8)),
                (o = SIMD.Float32x4.load(e, 12)),
                (s = SIMD.Float32x4.shuffle(i, r, 0, 1, 4, 5)),
                (a = SIMD.Float32x4.shuffle(n, o, 0, 1, 4, 5)),
                ...
                (s = SIMD.Float32x4.shuffle(i, r, 2, 3, 6, 7)),
                (a = SIMD.Float32x4.shuffle(n, o, 2, 3, 6, 7)),
                (u = SIMD.Float32x4.shuffle(s, a, 0, 2, 4, 6)),
                (c = SIMD.Float32x4.shuffle(s, a, 1, 3, 5, 7)),
                SIMD.Float32x4.store(t, 8, u),
                SIMD.Float32x4.store(t, 12, c),
                t
              );
            }),
            (n.transpose = r.USE_SIMD ? n.SIMD.transpose : n.scalar.transpose),
            (n.scalar.invert = function (t, e) {
              var i = e[0],
                r = e[1],
                n = e[2],
                o = e[3],
            ...
            (n.SIMD.invert = function (t, e) {
              ...
              return (
                ...
                (s = SIMD.Float32x4.mul(
                  SIMD.Float32x4.swizzle(r, 2, 3, 0, 1),
                  o
                )),
                (s = SIMD.Float32x4.swizzle(s, 1, 0, 3, 2)),
                (n = SIMD.Float32x4.swizzle(n, 2, 3, 0, 1)),
                (a = SIMD.Float32x4.add(SIMD.Float32x4.mul(n, s), a)),
                (h = SIMD.Float32x4.mul(i, s)),
                (s = SIMD.Float32x4.swizzle(s, 2, 3, 0, 1)),
                (a = SIMD.Float32x4.sub(a, SIMD.Float32x4.mul(n, s))),
                (h = SIMD.Float32x4.sub(SIMD.Float32x4.mul(i, s), h)),
                (h = SIMD.Float32x4.swizzle(h, 2, 3, 0, 1)),
                (s = SIMD.Float32x4.mul(i, r)),
                (s = SIMD.Float32x4.swizzle(s, 1, 0, 3, 2)),
                (h = SIMD.Float32x4.add(SIMD.Float32x4.mul(o, s), h)),
                (u = SIMD.Float32x4.sub(SIMD.Float32x4.mul(n, s), u)),
                (s = SIMD.Float32x4.swizzle(s, 2, 3, 0, 1)),
                (h = SIMD.Float32x4.sub(SIMD.Float32x4.mul(o, s), h)),
                (u = SIMD.Float32x4.sub(u, SIMD.Float32x4.mul(n, s))),
                (s = SIMD.Float32x4.mul(i, o)),
                (s = SIMD.Float32x4.swizzle(s, 1, 0, 3, 2)),
                (l = SIMD.Float32x4.sub(l, SIMD.Float32x4.mul(n, s))),
                (h = SIMD.Float32x4.add(SIMD.Float32x4.mul(r, s), h)),
                (s = SIMD.Float32x4.swizzle(s, 2, 3, 0, 1)),
                ...
                (c = SIMD.Float32x4.sub(
                  ...
                  SIMD.Float32x4.mul(c, SIMD.Float32x4.mul(s, s))
                )),
                (c = SIMD.Float32x4.swizzle(c, 0, 0, 0, 0))
                  ? (SIMD.Float32x4.store(t, 0, SIMD.Float32x4.mul(c, a)),
            ...
            (n.invert = r.USE_SIMD ? n.SIMD.invert : n.scalar.invert),
            (n.scalar.adjoint = function (t, e) {
              var i = e[0],
                r = e[1],
                n = e[2],
                o = e[3],
            ...
            (n.SIMD.adjoint = function (t, e) {
              ...
              return (
                ...
                (n = SIMD.Float32x4.load(e, 8)),
                (o = SIMD.Float32x4.load(e, 12)),
                (u = SIMD.Float32x4.shuffle(i, r, 0, 1, 4, 5)),
                (a = SIMD.Float32x4.shuffle(n, o, 0, 1, 4, 5)),
                (s = SIMD.Float32x4.shuffle(u, a, 0, 2, 4, 6)),
                (a = SIMD.Float32x4.shuffle(a, u, 1, 3, 5, 7)),
                (u = SIMD.Float32x4.shuffle(i, r, 2, 3, 6, 7)),
                (h = SIMD.Float32x4.shuffle(n, o, 2, 3, 6, 7)),
                ...
                (d = SIMD.Float32x4.mul(s, u)),
                (u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1)),
                (c = SIMD.Float32x4.sub(c, SIMD.Float32x4.mul(l, u))),
                (d = SIMD.Float32x4.sub(SIMD.Float32x4.mul(s, u), d)),
                (d = SIMD.Float32x4.swizzle(d, 2, 3, 0, 1)),
                (u = SIMD.Float32x4.mul(s, a)),
                (u = SIMD.Float32x4.swizzle(u, 1, 0, 3, 2)),
                (d = SIMD.Float32x4.add(SIMD.Float32x4.mul(h, u), d)),
                (f = SIMD.Float32x4.sub(SIMD.Float32x4.mul(l, u), f)),
                (u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1)),
                (d = SIMD.Float32x4.sub(SIMD.Float32x4.mul(h, u), d)),
                (f = SIMD.Float32x4.sub(f, SIMD.Float32x4.mul(l, u))),
                (u = SIMD.Float32x4.mul(s, h)),
                (u = SIMD.Float32x4.swizzle(u, 1, 0, 3, 2)),
                (p = SIMD.Float32x4.sub(p, SIMD.Float32x4.mul(l, u))),
                (d = SIMD.Float32x4.add(SIMD.Float32x4.mul(a, u), d)),
                (u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1)),
                (p = SIMD.Float32x4.add(SIMD.Float32x4.mul(l, u), p)),
                (d = SIMD.Float32x4.sub(d, SIMD.Float32x4.mul(a, u))),
                (u = SIMD.Float32x4.mul(s, l)),
                (u = SIMD.Float32x4.swizzle(u, 1, 0, 3, 2)),
                (p = SIMD.Float32x4.add(SIMD.Float32x4.mul(h, u), p)),
                (f = SIMD.Float32x4.sub(f, SIMD.Float32x4.mul(a, u))),
                (u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1)),
                (p = SIMD.Float32x4.sub(p, SIMD.Float32x4.mul(h, u))),
                (f = SIMD.Float32x4.add(SIMD.Float32x4.mul(a, u), f)),
            ...
            (n.adjoint = r.USE_SIMD ? n.SIMD.adjoint : n.scalar.adjoint),
            (n.determinant = function (t) {
              var e = t[0],
                i = t[1],
                r = t[2],
            ...
            (n.SIMD.multiply = function (t, e, i) {
              var r = SIMD.Float32x4.load(e, 0),
                ...
                l = SIMD.Float32x4.add(
                  SIMD.Float32x4.mul(SIMD.Float32x4.swizzle(a, 0, 0, 0, 0), r),
                  SIMD.Float32x4.add(
                    SIMD.Float32x4.mul(
              ...
              var h = SIMD.Float32x4.load(i, 4),
                u = SIMD.Float32x4.add(
                  SIMD.Float32x4.mul(SIMD.Float32x4.swizzle(h, 0, 0, 0, 0), r),
                  SIMD.Float32x4.add(
                    SIMD.Float32x4.mul(
              ...
              var c = SIMD.Float32x4.load(i, 8),
                p = SIMD.Float32x4.add(
                  ...
                  SIMD.Float32x4.add(
                    ...
                    SIMD.Float32x4.add(
                      SIMD.Float32x4.mul(
                        SIMD.Float32x4.swizzle(c, 2, 2, 2, 2),
                        o
                      ),
                      SIMD.Float32x4.mul(
                        SIMD.Float32x4.swizzle(c, 3, 3, 3, 3),
                        s
                      )
                    )
                  )
            ...
            (n.scalar.multiply = function (t, e, i) {
              ...
              return (
                ...
                (t[8] = g * r + x * a + w * c + M * m),
                (t[9] = g * n + x * l + w * p + M * v),
                (t[10] = g * o + x * h + w * d + M * _),
                (t[11] = g * s + x * u + w * f + M * y),
                (g = i[12]),
                (x = i[13]),
                (w = i[14]),
                (M = i[15]),
                (t[12] = g * r + x * a + w * c + M * m),
                (t[13] = g * n + x * l + w * p + M * v),
                (t[14] = g * o + x * h + w * d + M * _),
                (t[15] = g * s + x * u + w * f + M * y),
                t
              );
            }),
            (n.multiply = r.USE_SIMD ? n.SIMD.multiply : n.scalar.multiply),
            (n.mul = n.multiply),
            (n.scalar.translate = function (t, e, i) {
              var r,
                n,
                o,
                s,
              ...
              return (
                e === t
                  ? ((t[12] = e[0] * m + e[4] * v + e[8] * _ + e[12]),
                    (t[13] = e[1] * m + e[5] * v + e[9] * _ + e[13]),
                    (t[14] = e[2] * m + e[6] * v + e[10] * _ + e[14]),
                    (t[15] = e[3] * m + e[7] * v + e[11] * _ + e[15]))
                  : ((r = e[0]),
                    (n = e[1]),
                    (o = e[2]),
                    (s = e[3]),
                    ...
                    (t[10] = d),
                    (t[11] = f),
                    (t[12] = r * m + a * v + c * _ + e[12]),
                    (t[13] = n * m + l * v + p * _ + e[13]),
                    (t[14] = o * m + h * v + d * _ + e[14]),
                    (t[15] = s * m + u * v + f * _ + e[15])),
                t
              );
            }),
            (n.SIMD.translate = function (t, e, i) {
              ...
              var l = SIMD.Float32x4.add(
                r,
                SIMD.Float32x4.add(n, SIMD.Float32x4.add(o, s))
              );
              return SIMD.Float32x4.store(t, 12, l), t;
            }),
            (n.translate = r.USE_SIMD ? n.SIMD.translate : n.scalar.translate),
            (n.scalar.scale = function (t, e, i) {
              var r = i[0],
                n = i[1],
                o = i[2];
              return (
            ...
            (n.SIMD.scale = function (t, e, i) {
              ...
              return (
                (r = SIMD.Float32x4.load(e, 0)),
                SIMD.Float32x4.store(
                  t,
                  0,
                  SIMD.Float32x4.mul(r, SIMD.Float32x4.swizzle(s, 0, 0, 0, 0))
                ),
                (n = SIMD.Float32x4.load(e, 4)),
                SIMD.Float32x4.store(
                  t,
                  4,
                  SIMD.Float32x4.mul(n, SIMD.Float32x4.swizzle(s, 1, 1, 1, 1))
                ),
                (o = SIMD.Float32x4.load(e, 8)),
                SIMD.Float32x4.store(
                  t,
            ...
            (n.scale = r.USE_SIMD ? n.SIMD.scale : n.scalar.scale),
            ...
            (n.rotateX = r.USE_SIMD ? n.SIMD.rotateX : n.scalar.rotateX),
            (n.scalar.rotateY = function (t, e, i) {
              var r = Math.sin(i),
                n = Math.cos(i),
                o = e[0],
                s = e[1],
            ...
            (n.rotateY = r.USE_SIMD ? n.SIMD.rotateY : n.scalar.rotateY),
            (n.scalar.rotateZ = function (t, e, i) {
              var r = Math.sin(i),
                n = Math.cos(i),
                o = e[0],
                s = e[1],
            ...
            (n.rotateZ = r.USE_SIMD ? n.SIMD.rotateZ : n.scalar.rotateZ),
            (n.fromTranslation = function (t, e) {
              return (
                (t[0] = 1),
                (t[1] = 0),
            ...
            (n.getScaling = function (t, e) {
              var i = e[0],
                ...
                u = e[10];
              return (
                (t[0] = Math.sqrt(i * i + r * r + n * n)),
                (t[1] = Math.sqrt(o * o + s * s + a * a)),
                (t[2] = Math.sqrt(l * l + h * h + u * u)),
                t
              );
            }),
            ...
            (n.fromRotationTranslationScaleOrigin = function (t, e, i, r, n) {
              ...
              return (
                ...
                (t[10] = (1 - (p + m)) * b),
                (t[11] = 0),
                (t[12] = i[0] + S - (t[0] * S + t[4] * E + t[8] * I)),
                (t[13] = i[1] + E - (t[1] * S + t[5] * E + t[9] * I)),
                (t[14] = i[2] + I - (t[2] * S + t[6] * E + t[10] * I)),
                (t[15] = 1),
                t
              );
            }),
            ...
            (n.lookAt = function (t, e, i, o) {
              var s,
                ...
                b = i[1],
                S = i[2];
              return Math.abs(v - M) < r.EPSILON &&
                Math.abs(_ - b) < r.EPSILON &&
                Math.abs(y - S) < r.EPSILON
                ? n.identity(t)
                : ((p = v - M),
                  (d = _ - b),
                  (f = y - S),
                  (m = 1 / Math.sqrt(p * p + d * d + f * f)),
                  (p *= m),
                  (d *= m),
                  (f *= m),
                  (s = x * f - w * d),
            ...
            (n.equals = function (t, e) {
              ...
              return (
                Math.abs(i - g) <=
                  r.EPSILON * Math.max(1, Math.abs(i), Math.abs(g)) &&
                Math.abs(n - x) <=
                  r.EPSILON * Math.max(1, Math.abs(n), Math.abs(x)) &&
                Math.abs(o - w) <=
                  r.EPSILON * Math.max(1, Math.abs(o), Math.abs(w)) &&
                Math.abs(s - M) <=
                  r.EPSILON * Math.max(1, Math.abs(s), Math.abs(M)) &&
                Math.abs(a - b) <=
                  r.EPSILON * Math.max(1, Math.abs(a), Math.abs(b)) &&
                Math.abs(l - S) <=
                  r.EPSILON * Math.max(1, Math.abs(l), Math.abs(S)) &&
                Math.abs(h - E) <=
                  r.EPSILON * Math.max(1, Math.abs(h), Math.abs(E)) &&
                Math.abs(u - I) <=
                  r.EPSILON * Math.max(1, Math.abs(u), Math.abs(I)) &&
                Math.abs(c - D) <=
                  r.EPSILON * Math.max(1, Math.abs(c), Math.abs(D)) &&
                Math.abs(p - T) <=
                  r.EPSILON * Math.max(1, Math.abs(p), Math.abs(T)) &&
                Math.abs(d - L) <=
                  r.EPSILON * Math.max(1, Math.abs(d), Math.abs(L)) &&
                Math.abs(f - F) <=
                  r.EPSILON * Math.max(1, Math.abs(f), Math.abs(F)) &&
                Math.abs(m - C) <=
                  r.EPSILON * Math.max(1, Math.abs(m), Math.abs(C)) &&
                Math.abs(v - P) <=
                  r.EPSILON * Math.max(1, Math.abs(v), Math.abs(P)) &&
                Math.abs(_ - z) <=
                  r.EPSILON * Math.max(1, Math.abs(_), Math.abs(z)) &&
                Math.abs(y - R) <=
                  r.EPSILON * Math.max(1, Math.abs(y), Math.abs(R))
              );
            }),
            (e.exports = n);
        },
          ...
          (a.create = function () {
            ...
            (a.rotationTo = (function () {
              ...
              return function (r, n, s) {
                ...
                return l < -0.999999
                  ? (o.cross(t, e, n),
                    o.length(t) < 1e-6 && o.cross(t, i, n),
                    o.normalize(t, t),
                    a.setAxisAngle(r, t, Math.PI),
                    r)
                  : l > 0.999999
            ...
            (a.length = s.length),
            (a.len = a.length),
            (a.squaredLength = s.squaredLength),
            ...
            (a.fromMat3 = function (t, e) {
              ...
              if (r > 0)
                ...
                var o = (n + 1) % 3,
                  s = (n + 2) % 3;
                (i = Math.sqrt(e[3 * n + n] - e[3 * o + o] - e[3 * s + s] + 1)),
                  (t[n] = 0.5 * i),
                  (i = 0.5 / i),
                  (t[3] = (e[3 * o + s] - e[3 * s + o]) * i),
                  (t[o] = (e[3 * o + n] + e[3 * n + o]) * i),
            ...
            (a.exactEquals = s.exactEquals),
            (a.equals = s.equals),
            (e.exports = a);
        },
        { "./common.js": 3, "./mat3.js": 6, "./vec3.js": 10, "./vec4.js": 11 },
      ],
      9: [
        function (t, e, i) {
          var r = t("./common.js"),
          ...
          (n.create = function () {
            ...
            (n.transformMat2 = function (t, e, i) {
              var r = e[0],
                n = e[1];
              return (
                (t[0] = i[0] * r + i[2] * n), (t[1] = i[1] * r + i[3] * n), t
              );
            }),
            ...
            (n.equals = function (t, e) {
              ...
              return (
                Math.abs(i - o) <=
                  r.EPSILON * Math.max(1, Math.abs(i), Math.abs(o)) &&
                Math.abs(n - s) <=
          ...
          (n.create = function () {
            ...
            (n.hermite = function (t, e, i, r, n, o) {
              var s = o * o,
                ...
                u = s * (3 - 2 * o);
              return (
                (t[0] = e[0] * a + i[0] * l + r[0] * h + n[0] * u),
                (t[1] = e[1] * a + i[1] * l + r[1] * h + n[1] * u),
                (t[2] = e[2] * a + i[2] * l + r[2] * h + n[2] * u),
                t
              );
            }),
            (n.bezier = function (t, e, i, r, n, o) {
              var s = 1 - o,
                ...
                p = l * o;
              return (
                (t[0] = e[0] * h + i[0] * u + r[0] * c + n[0] * p),
                (t[1] = e[1] * h + i[1] * u + r[1] * c + n[1] * p),
                (t[2] = e[2] * h + i[2] * u + r[2] * c + n[2] * p),
                t
              );
            }),
            (n.random = function (t, e) {
      ...
      12: [
        function (e, i, r) {
          !(function (e, r, n, o) {
            ...
            function S(t, e) {
              for (
                var i, r, n = e[0].toUpperCase() + e.slice(1), s = 0;
                s < ct.length;
            ...
            function F(t, e) {
              ...
              (e.timeStamp = vt()),
                ...
                (e.scale = s ? Y(s.pointers, r) : 1),
                (e.rotation = s ? N(s.pointers, r) : 0),
                P(i, e);
              var h = t.element;
              y(e.srcEvent.target, h) && (h = e.srcEvent.target),
                (e.target = h);
            }
            function C(t, e) {
              var i = e.center,
            ...
            function B() {
              (this.evEl = Ht),
                Yt ? (this.evDoc = Nt) : (this.evWin = Nt),
                (this.allow = !0),
                (this.pressed = !1),
            ...
            function X(t, e) {
              ...
              return (
                e & (Et | It) && (i = b(i.concat(r), "identifier", !0)), [i, r]
              );
            }
            function W() {
              (this.evTarget = Zt),
            ...
            function V(t, e) {
              ...
              for (n = 0; n < s.length; )
                r[s[n].identifier] && a.push(s[n]),
                  e & (Et | It) && delete r[s[n].identifier],
                  n++;
            ...
            function K(t) {
              (this.id = E()),
                (this.manager = null),
                (this.options = u(t || {}, this.defaults)),
            ...
            function at(t, e) {
              return (
                (e = e || {}),
                (e.recognizers = m(e.recognizers, at.defaults.preset)),
                new lt(t, e)
              );
            }
            function lt(t, e) {
              (e = e || {}),
                (this.options = u(e, at.defaults)),
            ...
            function ht(t, e) {
              var i = t.element;
              i.style &&
                l(t.options.cssProps, function (t, r) {
            ...
            D.prototype = {
              ...
              init: function () {
                this.evEl && v(this.element, this.evEl, this.domHandler),
                  ...
                  this.evDoc && v(r, this.evDoc, this.domHandler),
                  this.evBody && v(r.body, this.evBody, this.domHandler);
              },
              destroy: function () {
                this.evEl && _(this.element, this.evEl, this.domHandler),
                  this.evTarget &&
                    _(this.target, this.evTarget, this.domHandler),
                  this.evWin && _(I(this.element), this.evWin, this.domHandler),
                  this.evDoc && _(r, this.evDoc, this.domHandler),
                  this.evBody && _(r.body, this.evBody, this.domHandler);
              },
            };
            var kt = { mousedown: bt, mousemove: St, mouseup: Et },
              Ht = "mousedown",
            ...
            p(B, D, {
              handler: function (t) {
                var e = kt[t.type],
                  i = 0;
                Yt && (i = 1),
                  e & bt && t.button === i && (this.pressed = !0),
                  e & St && t.button !== i && (e = Et),
                  this.pressed &&
                    this.allow &&
                    (e & Et && (this.pressed = !1),
            ...
            (K.prototype = {
              ...
              recognize: function (t) {
                ...
                this.state & (ae | le | 32) && (this.state = re),
                  (this.state = this.process(e)),
                  this.state & (ne | oe | se | le) && this.tryEmit(e);
              },
              process: function (t) {},
        ...
        function (t, e, i) {
          ...
          function r(t, e, i, r, n) {
            if (
              ...
              (n.perspective.extraTransforms =
                null != n.perspective.extraTransforms
                  ? n.perspective.extraTransforms
                  : ""),
              (n.perspective.radius || n.perspective.extraTransforms) && !o())
            )
              throw new Error(
          ...
          n(r),
            ...
            (r.prototype._update = function () {
              ...
              if (this._visible) {
                ...
                this._perspective.radius
                  ? ((o = !0), this._setEmbeddedPosition(s, r))
                  : (s.coordinatesToScreen(r, n),
                    (t = n.x),
                    (e = n.y),
                    null != t &&
                      null != e &&
            ...
            (r.prototype._setEmbeddedPosition = function (t, e) {
              var i = t.coordinatesToPerspectiveTransform(
                e,
                this._perspective.radius,
          ...
          n(r),
            ...
            (r.prototype._update = function () {
              ...
              if (
                ...
                (this._rect &&
                  (e !== this._stageWidth || i !== this._stageHeight))
              ) {
            ...
            (r.prototype.pinLevel = function (t) {
              for (
                var e = this._geometry.levelList[t],
                  i = this._geometry.levelTiles(e),
                  r = 0;
                r < i.length;
                r++
              )
                this._textureStore.pin(i[r]);
            }),
      ...
      18: [
        ...
        { "./util/clearOwnProperties": 90, "minimal-event-emitter": 13 },
      ],
      19: [
        function (t, e, i) {
          "use strict";
          ...
          a(r),
            ...
            (r.prototype.createLayer = function (t) {
              ...
              return (
                this._layers.push(u),
                t.pinFirstLevel && u.pinFirstLevel(),
            ...
            (r.prototype.lookTo = function (t, e, i) {
              ...
              c(a, t),
                c(a, s),
                n && o.normalizeToClosest && o.normalizeToClosest(a, a);
              var l = function (t) {
                  return (t *= 2) < 1
                    ? 0.5 * t * t
                    : -0.5 * (--t * (t - 2) - 1);
        ...
        function (t, e, i) {
          ...
          function n(t, e) {
            ...
            t.emit("textureStartLoad", e),
              m && console.log("loading", n, e),
              (i._cancel = h(s, e, function (o, s, a, l) {
                if (((i._cancel = null), o))
                  return (
                    a && a.destroy(),
                    l && l.destroy(),
                    void (o instanceof r
                      ? (t.emit("textureCancel", e),
                        m && console.log("cancel", n, e))
                      : (t.emit("textureError", e, o),
                        m && console.log("error", n, e)))
                  );
                (i._texture = l),
                  a.isDynamic()
                    ? ((i._asset = a),
                      a.addEventListener("change", i._changeHandler))
                    : a.destroy(),
                  t.emit("textureLoad", e),
                  m && console.log("load", n, e);
              }));
          }
          function o(t, e, i) {
            (i = u(i || {}, _)),
              ...
              (this._itemMap = new s()),
              (this._visible = new a()),
              (this._previouslyVisible = new l(i.previouslyVisibleCacheSize)),
              (this._pinMap = new s()),
              (this._newVisible = new a()),
          ...
          d(r, Error),
            ...
            (n.prototype.destroy = function () {
              ...
              n &&
                (n.removeEventListener("change", this._changeHandler),
                n.destroy()),
                o && o.destroy(),
                e.emit("textureUnload", i),
                m && console.log("unload", t, i),
                f(this);
            }),
            h(n),
            h(o),
            ...
            (o.prototype.startFrame = function () {
              if (this._state !== v.IDLE && this._state !== v.START)
                throw new Error(
            ...
            (o.prototype.markTile = function (t) {
              if (this._state !== v.START && this._state !== v.MARK)
                throw new Error(
            ...
            (o.prototype.endFrame = function () {
              ...
              (this._state = v.END),
                --this._delimCount || (this._update(), (this._state = v.IDLE));
            }),
          ...
          (r.prototype.search = function (t, e, i) {
            ...
            for (this._clear(), r.push(e); r.length > 0; ) {
              ...
              if (!n.has(a) && t.intersects(a.vertices(o))) {
                n.add(a);
                for (var l = a.neighbors(), h = 0; h < l.length; h++)
                  r.push(l[h]);
                i.push(a), s++;
              }
            }
        ...
        function (t, e, i) {
          ...
          function r(t, e) {
            ...
            g(n),
              x(n),
              w(n),
              this._controlContainer.appendChild(n),
              ...
              (this._renderLoop = new a(this._stage)),
              (this._controls = new l()),
              (this._controlMethods = v(
                this._controls,
                this._controlContainer,
                e.controls
              )),
              this._controls.attach(this._renderLoop),
              (this._hammerManagerTouch = m.get(
                this._controlContainer,
                "touch"
              )),
              (this._hammerManagerMouse = m.get(
                this._controlContainer,
                "mouse"
              )),
              (this._dragCursor = new f(
                this._controls,
                "mouseViewDrag",
                t,
          ...
          s(r),
            (r.prototype.destroy = function () {
              ...
              for (var t in this._controlMethods)
            ...
            (r.prototype.destroyScene = function (t) {
              ...
              if (this._currentScene === t) {
                for (
                  this._removeSceneEventListeners(t), r = t.listLayers(), i = 0;
                  i < r.length;
                  i++
                )
                  this._removeLayerFromStage(r[i]);
          ...
          (r.prototype.switchScene = function (t, e, i) {
            ...
            function o() {
              if (s._replacedScene) {
                s._removeSceneEventListeners(s._replacedScene),
                  (h = s._replacedScene.listLayers());
                for (var t = 0; t < h.length; t++)
                  s._removeLayerFromStage(h[t]);
            ...
            var h = l ? l.listLayers() : [],
              u = t.listLayers(),
              c = a.listLayers();
            if (l && (c.length !== h.length || (c.length > 1 && c[0] != h[0])))
              throw new Error("Stage not in sync with viewer");
            for (
              var p = null != e.transitionDuration ? e.transitionDuration : 1e3,
                d = null != e.transitionUpdate ? e.transitionUpdate : n,
                f = 0;
              f < u.length;
              f++
            )
              this._addLayerToStage(u[f]);
            (this._cancelCurrentTween = M(p, r, o)),
              (this._currentScene = t),
              (this._replacedScene = l),
              this.emit("sceneChange"),
          ...
          function r(t) {
            ...
            for (var i in a)
              if (n[i] && t instanceof n[i]) {
                (e = !0),
                  (this._widthProp = a[i][0]),
                  (this._heightProp = a[i][1]);
                break;
              }
            ...
            return function () {
              ...
              return function (g, x) {
                if (
                  ...
                  var w = (0.5 * f * f) / a;
                  (_ =
                    Math.abs(h - g.pitch) > w
                      ? Math.min(f + t * a, i)
                      : Math.max(f - t * a, 0)),
                    (o = _ * t),
                    h < g.pitch && (g.pitch = Math.max(h, g.pitch - o)),
                    h > g.pitch && (g.pitch = Math.min(h, g.pitch + o));
                }
                if (null != u && g.fov !== h) {
                  var M = (0.5 * m * m) / l;
                  (y =
                    Math.abs(u - g.fov) > M
                      ...
                      : Math.max(m - t * l, 0)),
                    (c = y * t),
                    u < g.fov && (g.fov = Math.max(u, g.fov - c)),
                    u > g.fov && (g.fov = Math.min(u, g.fov + c));
                }
          ...
          (r.prototype._index = function (t) {
            ...
            (r.prototype.del = function (t) {
              for (var e = 0; e < this._size; e++)
                if (t.equals(this._keys[this._index(e)])) {
                  for (
                    var i = this._values[this._index(e)], r = e;
                    r < this._size - 1;
                    r++
                  )
                    (this._keys[this._index(r)] =
                      this._keys[this._index(r + 1)]),
                      (this._values[this._index(r)] =
                        this._values[this._index(r + 1)]);
                  return this._size--, i;
                }
              return null;
            }),
            ...
            (r.prototype.forEach = function (t) {
              for (var e = 0, i = 0; i < this._size; i++)
                t(this._keys[this._index(i)], this._values[this._index(i)]),
                  (e += 1);
              return e;
            }),
            (e.exports = r);
              ...
              for (var e = 0; e < this._size; e++) {
                ...
                if (t.equals(i)) {
                  for (var r = e; r < this._size - 1; r++)
                    this._elements[this._index(r)] =
                      this._elements[this._index(r + 1)];
                  return this._size--, i;
                }
              }
              return null;
      ...
      30: [
        function (t, e, i) {
          ...
          (r.prototype.get = function (t) {
            ...
            (r.prototype.set = function (t, e) {
              for (
                var i = n(t.hash(), this._capacity),
                  r = this._keyBuckets[i],
                  o = this._valBuckets[i],
                  s = 0;
                s < r.length;
                s++
              ) {
            ...
            (r.prototype.del = function (t) {
              for (
                ...
                var s = i[o];
                if (t.equals(s)) {
                  for (var a = r[o], l = o; l < i.length - 1; l++)
                    (i[l] = i[l + 1]), (r[l] = r[l + 1]);
                  return (
                    (i.length = i.length - 1),
                    (r.length = r.length - 1),
            ...
            (r.prototype.forEach = function (t) {
              for (var e = 0, i = 0; i < this._capacity; i++)
                for (
                  var r = this._keyBuckets[i], n = this._valBuckets[i], o = 0;
                  o < r.length;
                  o++
                )
                  t(r[o], n[o]), (e += 1);
      ...
      31: [
        function (t, e, i) {
          ...
          (r.prototype.add = function (t) {
            for (
              var e = n(t.hash(), this._capacity), i = this._buckets[e], r = 0;
              r < i.length;
              r++
            ) {
              var o = i[r];
      ...
      34: [
        function (t, e, i) {
          ...
          function r(t) {
            var e = t || {};
            return (
              (e.colorOffset = e.colorOffset || a.create()),
              (e.colorMatrix = e.colorMatrix || l.create()),
              e
            );
          }
          function n(t, e, i) {
          ...
          function o(t, e, i) {
            var r = e[0],
              ...
              s = e[3];
            return (
              (t[0] = i[0] * r + i[1] * n + i[2] * o + i[3] * s),
              (t[1] = i[4] * r + i[5] * n + i[6] * o + i[7] * s),
              (t[2] = i[8] * r + i[9] * n + i[10] * o + i[11] * s),
              (t[3] = i[12] * r + i[13] * n + i[14] * o + i[15] * s),
              t
            );
          }
          function s(t, e) {
            for (
              var i = t.width, r = t.height, o = t.data, s = 0;
              s < i * r;
              s++
            )
              a.set(
          ...
          var a = t("gl-matrix").vec4,
            l = t("gl-matrix").mat4,
            h = a.create();
          e.exports = { identity: r, applyToPixel: n, applyToImageData: s };
        },
        { "gl-matrix": 2 },
      ],
      35: [
          ...
          n(r),
            ...
            (r.prototype.remove = function (t) {
              ...
              if (e >= 0) {
                ...
                i.instance.removeEventListener(
                  "parameterDynamics",
                  i.parameterDynamicsHandler
                );
              }
            }),
            (r.prototype.has = function (t) {
            ...
            (r.prototype._updateDynamics = function (t, e, i) {
              ...
              var n = this._now();
              r.dynamics.update(i, (n - r.time) / 1e3),
                (r.time = n),
                this.emit("change");
            }),
            ...
            (r.prototype.offsets = function () {
              ...
              for (var r = 0; r < this._methods.length; r++)
                for (
                  var n = this._methods[r].dynamics, o = 0;
      ...
      36: [
        function (t, e, i) {
          ...
          var n = t("../util/defaults"),
            o = t("../util/clearOwnProperties"),
            s = { active: "move", inactive: "default", disabled: "default" };
          (r.prototype.destroy = function () {
        ...
        { "../util/clearOwnProperties": 90, "../util/defaults": 95 },
      ],
      37: [
        function (t, e, i) {
          "use strict";
          ...
          n(r),
            ...
            (r.prototype._updateComposer = function () {
              ...
              for (var e in this._methods) {
                ...
                r && !t.has(i.instance) && t.add(i.instance),
                  !r && t.has(i.instance) && t.remove(i.instance);
              }
            }),
            (r.prototype._updateViewsWithControls = function () {
              ...
              for (
                ...
                this.updatedViews_.indexOf(r) < 0 &&
                  (e[i].view().updateWithControlParameters(t.offsets),
        ...
        function (t, e, i) {
          ...
          function r(t, e, i) {
            (this._element = t),
              ...
              (this._active = !1),
              (this._dynamics = { x: new o(), y: new o() }),
              (this._hammer = s.get(t, e)),
              this._hammer.on(
                "hammer.input",
        ...
        function (t, e, i) {
          ...
          (r.equals = function (t, e) {
            ...
            (r.prototype.update = function (t, e) {
              ...
              i && ((this.offset = this.offset || 0), (this.offset += i)),
            ...
            (r.prototype.velocityAfter = function (t) {
              return this.velocity
                ? this.friction
                  ? n(this.velocity, this.friction * t)
                  : this.velocity
                : null;
            }),
      ...
      41: [
        function (t, e, i) {
          ...
          (n.prototype.get = function (t, e) {
            ...
            return (
              this._managers[i] ||
                ((this._managers[i] = this._createManager(t, e)),
                (this._refCount[i] = 0)),
              this._refCount[i]++,
              new o(this, this._managers[i], t, e)
            );
          }),
            (n.prototype._createManager = function (t, e) {
              ...
              return (
                "mouse" === e
                  ? i.add(
                      new s.Pan({ direction: s.DIRECTION_ALL, threshold: 0 })
                    )
                  : ("touch" !== e && "pen" !== e && "kinect" !== e) ||
                    ...
                    (a.msie && parseFloat(a.version) < 10) ||
                      i.add(new s.Pinch())),
                i
              );
            }),
            (n.prototype._releaseHandle = function (t, e) {
              ...
              this._refCount[i] &&
                (--this._refCount[i] ||
                  ...
                  delete this._managers[i],
                  delete this._refCount[i]));
            }),
            (o.prototype.on = function (t, e) {
              ...
              this._eventHandlers.push({ events: t, handler: r }),
      ...
      45: [
        function (t, e, i) {
          ...
          function r(t, e) {
            (this._opts = l(e || {}, u)),
              (this._dynamics = new s()),
              (this._eventList = []);
            var i = this._opts.frictionTime
              ? this.withSmoothing
          ...
          var o = t("minimal-event-emitter"),
            ...
            l = t("../util/defaults"),
            h = t("../util/clearOwnProperties"),
            u = { frictionTime: 0.2, zoomDelta: 0.001 };
          o(r),
            (r.prototype.destroy = function () {
              this._wheelListener.destroy(), h(this);
            }),
            (r.prototype.withoutSmoothing = function (t) {
              (this._dynamics.offset = n(t) * this._opts.zoomDelta),
                this.emit("parameterDynamics", "zoom", this._dynamics),
                t.preventDefault(),
                this.emit("active"),
                this.emit("inactive");
            ...
            (r.prototype.withSmoothing = function (t) {
              ...
              for (var i = 0, r = 0; r < this._eventList.length; r++) {
                i +=
                  (n(this._eventList[r]) * this._opts.zoomDelta) /
                  this._opts.frictionTime;
              }
              (this._dynamics.velocity = i),
                (this._dynamics.friction =
                  Math.abs(i) / this._opts.frictionTime),
                this.emit("parameterDynamics", "zoom", this._dynamics),
                t.preventDefault(),
                this.emit("active"),
                this.emit("inactive");
        ...
        function (t, e, i) {
          ...
          function r(t, e, i) {
            ...
            if ("wheel" === r)
              (this._fun = e),
                (this._elem = t),
                this._elem.addEventListener("wheel", this._fun, i);
            else {
              if ("mousewheel" !== r)
                throw new Error("Browser does not support mouse wheel events");
              (this._fun = n(e)),
                (this._elem = t),
                this._elem.addEventListener("mousewheel", this._fun, i);
            }
          }
          function n(t) {
            return function (e) {
              ...
              return (
                (i.deltaY = -0.025 * e.wheelDelta),
                e.wheelDeltaX && (i.deltaX = -0.025 * e.wheelDeltaX),
                t(i)
              );
            };
          }
        ...
        function (t, e, i) {
          ...
          function r(t, e, i) {
            ...
            var r = {
              ...
              pinch: new l(e, "touch"),
              leftArrowKey: new h(37, "x", -0.7, 3),
              rightArrowKey: new h(39, "x", 0.7, 3),
              upArrowKey: new h(38, "y", -0.7, 3),
              downArrowKey: new h(40, "y", 0.7, 3),
              plusKey: new h(107, "zoom", -0.7, 3),
              minusKey: new h(109, "zoom", 0.7, 3),
              wKey: new h(87, "y", -0.7, 3),
              aKey: new h(65, "x", -0.7, 3),
              sKey: new h(83, "y", 0.7, 3),
              dKey: new h(68, "x", 0.7, 3),
              qKey: new h(81, "roll", 0.7, 3),
              eKey: new h(69, "roll", -0.7, 3),
            };
      ...
      49: [
        function (t, e, i) {
          ...
          e.exports = { maxFriction: r, changeVectorNorm: n };
        },
        {},
      ],
      50: [
        function (t, e, i) {
          ...
          function s(t) {
            ...
            (this.levelList = p(t, o)),
              (this.selectableLevelList = d(this.levelList));
            for (var e = 1; e < this.levelList.length; e++)
              this.levelList[e]._validateWithParentLevel(this.levelList[e - 1]);
            (this._tileSearcher = new h(this)),
              (this._neighborsCache = new u(g)),
              (this._vec = y.create()),
              (this._viewSize = {});
          }
          for (
            var a = t("../util/inherits"),
              l = t("../util/hash"),
              h = t("../TileSearcher"),
              u = t("../collections/LruMap"),
              c = t("./Level"),
              p = t("./common").makeLevelList,
              d = t("./common").makeSelectableLevelList,
              f = t("../util/clamp"),
              m = t("../util/cmp"),
              v = t("../util/type"),
              _ = t("gl-matrix").vec3,
          ...
          (n.prototype.rotX = function () {
            ...
            (n.prototype.vertices = function (t) {
              ...
              return (
                e(t[0], n, a), e(t[1], o, a), e(t[2], o, s), e(t[3], n, s), t
              );
            }),
            (n.prototype.parent = function () {
              ...
              return new n(
                t,
                Math.floor(
                  (i / s.numHorizontalTiles()) * a.numHorizontalTiles()
                ),
                Math.floor((r / s.numVerticalTiles()) * a.numVerticalTiles()),
                e - 1,
                o
              );
            }),
            ...
            (n.prototype.neighbors = function () {
              ...
              for (
                var o = t._vec,
                  ...
                  h = this.z,
                  u = this._level,
                  c = u.numHorizontalTiles(),
                  p = u.numVerticalTiles(),
                  d = [],
                  m = 0;
                m < L.length;
                m++
                ...
                if (g < 0 || g >= c || x < 0 || x >= p) {
                  var S = this.centerX(),
                    E = this.centerY();
                  g < 0
                    ? (_.set(o, -0.5, E, -0.5), (b = T[s][0]))
                    : g >= c
                    ? (_.set(o, 0.5, E, -0.5), (b = T[s][1]))
                    : x < 0
                    ? (_.set(o, S, 0.5, -0.5), (b = T[s][2]))
                    : x >= p && (_.set(o, S, -0.5, -0.5), (b = T[s][3]));
                  var I;
                  (I = w[s]),
                    r(o, 0, I.x, I.y),
                    (I = w[b]),
                    r(o, 0, -I.x, -I.y),
                    (g = f(Math.floor((0.5 + o[0]) * c), 0, c - 1)),
                    (x = f(Math.floor((0.5 - o[1]) * p), 0, p - 1));
                }
            ...
            (n.prototype.cmp = function (t) {
              return (
                m(this.z, t.z) ||
                m(x.indexOf(this.face), x.indexOf(t.face)) ||
                m(this.y, t.y) ||
                m(this.x, t.x)
              );
            }),
            ...
            (s.prototype._closestTile = function (t, e) {
              var i = this._vec;
              y.set(i, 0, 0, 1, 1),
                y.transformMat4(i, i, t.inverseProjection());
              var o = Infinity,
                s = null;
              for (var a in b) {
                var l = b[a],
              ...
              for (
                var u =
                    Math.max(Math.abs(i[0]), Math.abs(i[1]), Math.abs(i[2])) /
                    0.5,
                  c = 0;
                c < 3;
                c++
              ...
              return new n(
                s,
                f(Math.floor((0.5 + i[0]) * m), 0, m - 1),
                f(Math.floor((0.5 - i[1]) * v), 0, v - 1),
                d,
                this
              );
            }),
            (s.prototype.visibleTiles = function (t, e, i) {
              ...
              if (((i = i || []), t.size(r), 0 === r.width || 0 === r.height))
                return i;
            ...
            (s.Tile = s.prototype.Tile = n),
            (s.type = s.prototype.type = "cube"),
            (n.type = n.prototype.type = "cube"),
            (e.exports = s);
        },
        {
          "../TileSearcher": 21,
      ...
      51: [
        function (t, e, i) {
          ...
          function o(t) {
            if ("array" !== c(t))
              throw new Error("Level list must be an array");
            (this.levelList = h.makeLevelList(t, n)),
              (this.selectableLevelList = h.makeSelectableLevelList(
                this.levelList
              ));
          }
          ...
          (r.prototype.rotX = function () {
            ...
            (r.prototype.parent = function () {
              return this.atTopLevel()
                ? null
                : new r(this.z - 1, this._geometry);
            }),
            (r.prototype.children = function (t) {
              return this.atBottomLevel()
                ? null
                : ((t = t || []), t.push(new r(this.z + 1, this._geometry)), t);
            }),
            ...
            (o.Tile = o.prototype.Tile = r),
            (o.type = o.prototype.type = "equirect"),
            (r.type = r.prototype.type = "equirect"),
            (e.exports = o);
        },
        {
          "../util/cmp": 91,
      ...
      52: [
        function (t, e, i) {
          ...
          function o(t) {
            if ("array" !== v(t))
              throw new Error("Level list must be an array");
            (this.levelList = c(t, n)),
              (this.selectableLevelList = p(this.levelList));
            for (var e = 1; e < this.levelList.length; e++)
              this.levelList[e]._validateWithParentLevel(this.levelList[e - 1]);
            (this._tileSearcher = new l(this)),
              (this._neighborsCache = new h(g)),
              (this._vec = y.create()),
              (this._viewSize = {});
          }
          var s = t("../util/inherits"),
          ...
          (r.prototype.rotX = function () {
            ...
            (r.prototype.children = function (t) {
              ...
              return (
                (t = t || []),
                t.push(new r(2 * this.x, 2 * this.y, i, e)),
                t.push(new r(2 * this.x, 2 * this.y + 1, i, e)),
                t.push(new r(2 * this.x + 1, 2 * this.y, i, e)),
                t.push(new r(2 * this.x + 1, 2 * this.y + 1, i, e)),
                t
              );
            }),
            (r.prototype.neighbors = function () {
            ...
            (o.prototype._closestTile = function (t, e) {
              ...
              return new r(
                d(Math.floor((n * a) / h), 0, c - 1),
                d(Math.floor((o * l) / u), 0, p - 1),
                s,
                this
              );
            }),
            ...
            (o.Tile = o.prototype.Tile = r),
            (o.type = o.prototype.type = "flat"),
            (r.type = r.prototype.type = "flat"),
            (e.exports = o);
        },
        {
          "../TileSearcher": 21,
      ...
      54: [
        function (t, e, i) {
          ...
          var o = t("../util/cmp");
          e.exports = { makeLevelList: r, makeSelectableLevelList: n };
        },
        { "../util/cmp": 91 },
      ],
      55: [
      ...
      56: [
        function (t, e, i) {
          ...
          (r.prototype.loadImage = function (t, e, i) {
            function r(e, s) {
              s === f &&
                (l.removeFlashCallbackListener("imageLoaded", r),
                e ? i(new o("Network error: " + t)) : i(null, new n(h, f)));
            }
            function a() {
              h.cancelImage(f),
                l.removeFlashCallbackListener("imageLoaded", r),
        ...
        { "../NetworkError": 17, "../assets/Flash": 25, "../util/once": 108 },
      ],
      57: [
        function (t, e, i) {
          "use strict";
            ...
            return (
              ...
              (a.onload = function () {
                if (0 === l && 0 === h && 1 === u && 1 === c) i(null, new n(a));
                  ...
                  t.getContext("2d").drawImage(a, l, h, u, c, 0, 0, u, c),
                    i(null, new n(t));
                }
              }),
              (a.onerror = function () {
        ...
        { "../NetworkError": 17, "../assets/Static": 26, "../util/once": 108 },
      ],
      58: [
        function (t, e, i) {
          "use strict";
          ...
          function n(t, e, i) {
            ...
            t.appendChild(r),
              ...
              a(r),
              l(r),
              this._browserQuirks.useNullTransform && h(r),
              (this.domElement = r),
              (this._oldTileList = []),
              (this._newTileList = []),
              (this._textureMap = new o());
          }
          ...
          (n.prototype.destroy = function () {
            ...
            (n.prototype.startLayer = function (t, e) {
              ...
              (i.style.left = s(r * e.left) + "px"),
                (i.style.top = s(n * e.top) + "px"),
                (i.style.width = s(r * e.width) + "px"),
                (i.style.height = s(n * e.height) + "px");
              var o = 1,
                a = t.effects();
              a && null != a.opacity && (o = a.opacity),
                (i.style.opacity = o),
            ...
            (n.prototype.endLayer = function (t, e) {
              ...
              for (
                m.sort(r), i = 0, o = f[i], h = d.firstChild, n = 0;
                n < m.length;
                n++
              ) {
                for (s = m[n]; i < f.length && !(o.cmp(s) >= 0); )
                  (c = h.nextSibling), d.removeChild(h), (h = c), (o = f[++i]);
                if (((a = v.get(s)), !(l = a ? a._canvas : null)))
                ...
                u(l, this.calculateTransform(s, a, _)),
                  p && l.setAttribute("data-tile", s.str());
              }
      ...
      59: [
        function (t, e, i) {
          ...
          var n = t("../geometries/Cube").Tile,
            ...
            s = t("../util/decimal");
          t("../util/inherits")(r, o),
            (r.prototype.calculateTransform = function (t, e, i) {
        ...
        function (t, e, i) {
          ...
          t("../util/inherits")(r, o),
            (r.prototype.calculateTransform = function (t, e, i) {
              ...
              var l = o / i._zoomX(),
                h = a / i._zoomY(),
                u = t.centerX() - t.scaleX() / 2 + 0.5,
                c = 0.5 - t.centerY() - t.scaleY() / 2,
                p = u * l,
                d = c * h;
              ...
              (0 === v && 0 === _) ||
                (n +=
                  "translateX(" + s(-v) + "px) translateY(" + s(-_) + "px) ");
      ...
      61: [
        ...
        { "../collections/Map": 30, "../util/clearOwnProperties": 90 },
      ],
      62: [
        function (t, e, i) {
          "use strict";
          function r(t, e, i) {
            this.constructor.super_.call(this, t, e, i, o),
              (this._flashTileList = []);
          }
          var n = t("./FlashBase"),
            ...
            a = t("../util/radToDeg");
          s(r, n),
            (r.prototype._renderOnFlash = function (t, e) {
      ...
      64: [
        function (t, e, i) {
          ...
          function r(t) {
            (this.gl = t),
              (this.projMatrix = n.create()),
              (this.viewportMatrix = n.create()),
              (this.translateVector = o.create()),
              (this.scaleVector = o.create()),
              (this.constantBuffers = l(t, x, w, M)),
              (this.shaderProgram = u(t, y, g, b, S));
          }
          ...
          (r.prototype.destroy = function () {
            h(this.gl, this.constantBuffers),
            ...
            (r.prototype.renderTile = function (t, e, i, r) {
              ...
              (h[0] = t.centerX()),
                ...
                (u[1] = t.scaleY()),
                (u[2] = 1),
                n.copy(l, i.view().projection()),
                n.rotateX(l, l, t.rotX()),
                n.rotateY(l, l, t.rotY()),
                n.translate(l, l, h),
                n.scale(l, l, u),
                ...
                o.drawElements(o.TRIANGLES, x.length, o.UNSIGNED_SHORT, 0);
            }),
            (e.exports = r);
        },
        {
        ...
        function (t, e, i) {
          ...
          function n(t, e, i, n, o) {
            ...
            if (
              ...
              throw t.getProgramInfoLog(l);
            for (var h = 0; h < n.length; h++) {
              var u = n[h];
              if (((l[u] = t.getAttribLocation(l, u)), -1 === l[u]))
                throw new Error("Shader program has no " + u + " attribute");
            }
            for (var c = 0; c < o.length; c++) {
              var p = o[c];
              if (((l[p] = t.getUniformLocation(l, p)), -1 === l[p]))
          ...
          function h(t, e) {
            for (
              var i = t.getProgramParameter(e, t.ACTIVE_ATTRIBUTES), r = 0;
              r < i;
              r++
            )
          ...
          function d(t, e, i) {
            ...
            var n = M;
            e && e.colorOffset && (n = e.colorOffset),
              t.uniform4fv(i.colorOffset, n);
            var o = b;
            e && e.colorMatrix && (o = e.colorMatrix),
              t.uniformMatrix4fv(i.colorMatrix, !1, o);
          }
          function f(t, e, i, r) {
            ...
            var n = i.x,
              ...
              f = _(i.height - p, 0, d),
              m = i.height - f;
            g.set(E, i.width / l, i.height / f, 1),
              g.set(S, (h - s) / l, (m - p) / f, 0),
              x.identity(r),
              x.translate(r, r, S),
              x.scale(r, r, E),
              t.viewport(
                ...
                t.drawingBufferWidth * l,
                t.drawingBufferHeight * f
              );
          }
          var m = 256,
            v = 256,
      ...
      66: [
        ...
        { "../util/inherits": 103, "./WebGlBase": 64 },
      ],
      67: [
        function (t, e, i) {
          "use strict";
          function r(t) {
            (this.gl = t),
              (this.invProjMatrix = n.create()),
              (this.viewportMatrix = n.create()),
              (this.constantBuffers = a(t, g, x, w)),
              (this.shaderProgram = h(t, _, y, M, b));
          }
          var n = t("gl-matrix").mat4,
            o = t("../util/clearOwnProperties"),
            s = t("./WebGlCommon"),
          ...
          (r.prototype.destroy = function () {
            ...
            (r.prototype.startLayer = function (t, e) {
              ...
              i.useProgram(r),
                c(i, r),
                d(i, t, e, a),
                i.uniformMatrix4fv(r.uViewportMatrix, !1, a),
                i.bindBuffer(i.ARRAY_BUFFER, o.vertexPositions),
                i.vertexAttribPointer(
                  r.aVertexPosition,
                  3,
                  i.FLOAT,
                ...
                i.bindBuffer(i.ARRAY_BUFFER, o.textureCoords),
                n.copy(s, t.view().projection()),
                n.invert(s, s),
                i.uniformMatrix4fv(r.uInvProjMatrix, !1, s);
              var l = t.effects().textureCrop || {},
                h = null != l.x ? l.x : 0,
                u = null != l.y ? l.y : 0,
                p = null != l.width ? l.width : 1,
                m = null != l.height ? l.height : 1;
              i.uniform1f(r.uTextureX, h),
                i.uniform1f(r.uTextureY, u),
                i.uniform1f(r.uTextureWidth, p),
                i.uniform1f(r.uTextureHeight, m),
                f(i, t.effects(), {
                  opacity: r.uOpacity,
                  colorOffset: r.uColorOffset,
                  colorMatrix: r.uColorMatrix,
      ...
      69: [
        function (t, e, i) {
          ...
          function r(t) {
            switch (t.type) {
              case "webgl":
                t.registerRenderer("flat", "flat", o),
                  t.registerRenderer("cube", "rectilinear", n),
                  t.registerRenderer("equirect", "rectilinear", s);
                break;
              case "css":
                t.registerRenderer("flat", "flat", l),
                  t.registerRenderer("cube", "rectilinear", a);
                break;
              case "flash":
                t.registerRenderer("flat", "flat", u),
                  t.registerRenderer("cube", "rectilinear", h);
                break;
              default:
      ...
      74: [
        function (t, e, i) {
          ...
          function r(t, e) {
            (e = e || {}),
              (this._loadPool = new a({ concurrency: e.concurrency || c })),
              (this._retryDelay = e.retryDelay || p),
              (this._retryMap = {}),
          ...
          var o = t("minimal-event-emitter"),
            ...
            l = t("../util/chain"),
            h = t("../util/delay"),
            u = (t("../util/now"), { x: "x", y: "y", z: "z", f: "face" }),
            c = 4,
            p = 1e4;
          o(r),
              ...
              var r,
                ...
                f = function (t) {
                  return n._loadPool.push(d, function (i, r) {
                    i
                      ? (i instanceof s &&
                          ((a[c] = v()), n.emit("networkError", r, i)),
                        t(i, e))
                      : (delete a[c], t(null, e, r));
                  });
                },
                m = a[c];
              if (null != m) {
        ...
        function (t, e, i) {
          ...
          var o = t("./Stage"),
            ...
            f = {
              ...
              perspectiveNudge: l.webkit || l.gecko ? 0.001 : 0,
            };
          h(r, o),
            (r.prototype.destroy = function () {
            ...
            (r.prototype.setSizeForType = function () {}),
            (r.prototype.loadImage = function (t, e, i) {
              return this._loader.loadImage(t, e, i);
            }),
            (r.prototype.validateLayer = function (t) {}),
            ...
            (r.prototype.takeSnapshot = function () {
              throw new Error("CssStage: takeSnapshot not implemented");
            }),
            (r.type = r.prototype.type = "css"),
            (n.prototype.refresh = function (t, e) {
              ...
              if (i !== this._timestamp) {
                ...
                (r.width = c + s + p),
                  (r.height = h + a + u),
                  n.drawImage(o, c, h, s, a);
                var d;
                for (d = 0; d < h; d++) n.drawImage(r, c, h, s, 1, c, d, s, 1);
                for (d = 0; d < c; d++) n.drawImage(r, c, h, 1, a, d, h, 1, a);
                for (d = 0; d < u; d++)
                  n.drawImage(r, c, h + a - 1, s, 1, c, h + a + d, s, 1);
                for (d = 0; d < p; d++)
                  n.drawImage(r, c + s - 1, h, 1, a, c + s + d, h, 1, a);
              }
            }),
            (n.prototype.destroy = function () {
              d(this);
            }),
            (r.TextureClass = r.prototype.TextureClass = n),
            (e.exports = r);
        },
        {
      ...
      77: [
        function (t, e, i) {
          ...
          function n(t) {
            if (
              (this.constructor.super_.call(this, t),
              (this._wmode = (t && t.wmode) || _),
              (this._swfPath = (t && t.swfPath) || y),
              !y)
            )
              throw new Error("Missing SWF path");
            (this._flashStageId = r()),
              (this._callbacksObj = window[g][this._flashStageId] = {}),
              (this._stageCallbacksObjVarName =
                g + "[" + this._flashStageId + "]"),
              (this._callbackListeners = {});
            for (var e = 0; e < x.length; e++)
              this._callbacksObj[x[e]] = this._callListeners(x[e]);
            (this._loader = new l(this)),
              (this._loadImageQueue = new u()),
            ...
            (this._domElement = i.root),
              (this._blockingElement = i.blocking),
              (this._flashElement = i.flash),
          ...
          g in window || (window[g] = { __next: 0 });
          var x = ["imageLoaded"],
            w = { padSize: 3 };
          c(n, a),
            (n.prototype.destroy = function () {
              (window[g][this._flashStageId] = null),
            ...
            (n.prototype.addFlashCallbackListener = function (t, e) {
            ...
            (n.prototype._callListeners = function (t) {
              ...
              return function () {
                for (
                  var i = e._callbackListeners[t] || [], r = 0;
                  r < i.length;
                  r++
                ) {
                  p(i[r], arguments);
            ...
            (n.prototype.takeSnapshot = function (t) {
        ...
        function (t, e, i) {
          ...
          function o(t) {
            (this._progressive = !(!t || !t.progressive)),
              ...
              (this._tmpRect = {}),
              (this._tmpSize = {}),
              (this._createTextureWorkQueue = new a()),
              (this._emitRenderInvalid = this._emitRenderInvalid.bind(this)),
              (this._rendererRegistry = new p());
          }
          ...
          s(o),
            ...
            (o.prototype.removeLayer = function (t) {
              ...
              this.destroyRenderer(r),
                i.removeEventListener("viewChange", this._emitRenderInvalid),
                i.removeEventListener("effectsChange", this._emitRenderInvalid),
            ...
            (o.prototype.render = function () {
              ...
              if (!(s <= 0 || a <= 0)) {
                ...
                for (t = 0; t < this._layers.length; t++) {
                  ...
                  if (
                    (l(s, a, f && f.rect, h), !(h.width <= 0 || h.height <= 0))
                  ) {
                    for (
                      u.width = h.width * this._width,
                        u.height = h.height * this._height,
                        m.setSize(u),
                        _.startLayer(d, h),
                        i = this._collectTiles(d, v),
                        e = 0;
                      e < r.length;
                      e++
                    )
                    ...
                    for (e = 0; e < n.length; e++)
                      (c = n[e]), (p = v.texture(c)), _.renderTile(c, p, d, y);
                    d.emit("renderComplete", i),
                      i || (o = !1),
                      _.endLayer(d, h);
                  }
                }
            ...
            (o.prototype._collectTiles = function (t, e) {
              ...
              for (var a = !0, l = 0; l < s.length; l++) {
                ...
                this._collectTileToLoad(u),
                  e.texture(u)
                    ? ((h = !1), this._collectTileToRender(u))
                    : ((h = this._collectChildren(u, e)), (a = !1)),
                  this._collectParents(u, e, h);
              }
        ...
        function (t, e, i) {
          ...
          function r(t, e) {
            ...
            return (
              v &&
                "undefined" != typeof WebGLDebugUtils &&
                ((r = WebGLDebugUtils.makeDebugContext(r)),
          ...
          function n(t) {
            ...
            this.constructor.super_.call(this, t),
              ...
              (this._loader = new a(this)),
              (this._domElement = document.createElement("canvas")),
              d(this._domElement),
              f(this._domElement),
              (this._gl = r(this._domElement, t)),
          ...
          u(n, s),
              ...
              if (o !== this._timestamp) {
                ...
                if (a !== this._width || l !== this._height) {
                  ...
                  (i = this._texture),
                    ...
                    r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL, !0),
                    r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0),
                    s instanceof HTMLVideoElement && _.videoUseTexImage2D
                      ? r.texImage2D(
                          r.TEXTURE_2D,
                          0,
                          r.RGBA,
            ...
            (n.TextureClass = n.prototype.TextureClass = o),
            (e.exports = n);
        },
        {
          "../loaders/HtmlImage": 57,
        ...
        function (t, e, i) {
          ...
          function r() {
            ...
            if (i && "WebkitPerspective" === t) {
              ...
              (n.textContent =
                "@media(-webkit-transform-3d){#" + r + "{height: 3px;})"),
        ...
        function (t, e, i) {
          ...
          function r() {
            ...
            if (
              ...
              i["application/x-shockwave-flash"].enabledPlugin
            )
              (r = e["Shockwave Flash"].description),
                (r = r.replace(/^.*\s+(\S+\s+\S+$)/, "$1")),
                (t = [0, 0, 0]),
                (t[0] = parseInt(r.replace(/^(.*)\..*$/, "$1"), 10)),
                (t[1] = parseInt(r.replace(/^.*\.(.*)\s.*$/, "$1"), 10)),
                (t[2] = /[a-zA-Z]/.test(r)
                  ? parseInt(r.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10)
                  : 0);
      ...
      110: [
        ...
        { "../support/Css": 81, "./decimal": 94, "./dom": 99 },
      ],
      111: [
        function (t, e, i) {
          "use strict";
      ...
      116: [
        function (t, e, i) {
          ...
          function r(t, e) {
            ...
            (this._x = t && null != t.x ? t.x : d),
              (this._y = t && null != t.y ? t.y : f),
              (this._zoom = t && null != t.zoom ? t.zoom : m),
              (this._mediaAspectRatio = t.mediaAspectRatio),
              (this._width = t && null != t.width ? t.width : c),
              (this._height = t && null != t.height ? t.height : p),
              (this._limiter = e || null),
              (this._projMatrix = o.create()),
              (this._invProjMatrix = o.create()),
          ...
          n(r),
            ...
            (r.prototype._update = function (t) {
              ...
              if (
                ...
                (t.mediaAspectRatio =
                  null != t.mediaAspectRatio ? t.mediaAspectRatio : n),
            ...
            (r.prototype.selectLevel = function (t) {
              for (
                var e = a() * this.width(), i = this._zoom, r = 0;
                r < t.length;
                r++
              ) {
                var n = t[r];
            ...
            (r.prototype.coordinatesToScreen = function (t, e) {
              ...
              var o = t && null != t.x ? t.x : d,
                a = t && null != t.y ? t.y : f;
              s.set(i, o - 0.5, 0.5 - a, -1, 1),
                s.transformMat4(i, i, this.projection());
              for (var l = 0; l < 3; l++) i[l] /= i[3];
              return (
                (e.x = (r * (i[0] + 1)) / 2), (e.y = (n * (1 - i[1])) / 2), e
              );
            }),
            (r.prototype.screenToCoordinates = function (t, e) {
              ...
              return (
                s.set(i, o, a, 1, 1),
                s.transformMat4(i, i, this.inverseProjection()),
                (e.x = 0.5 + i[0]),
                (e.y = 0.5 - i[1]),
                e
              );
      ...
      117: [
        function (t, e, i) {
          "use strict";
          function r(t, e) {
            (this._yaw = t && null != t.yaw ? t.yaw : _),
              (this._pitch = t && null != t.pitch ? t.pitch : y),
              (this._roll = t && null != t.roll ? t.roll : g),
              (this._fov = t && null != t.fov ? t.fov : x),
              (this._width = t && null != t.width ? t.width : m),
              (this._height = t && null != t.height ? t.height : v),
              (this._projectionCenterX =
                t && null != t.projectionCenterX ? t.projectionCenterX : w),
              (this._projectionCenterY =
                t && null != t.projectionCenterY ? t.projectionCenterY : M),
              (this._limiter = e || null),
              (this._projMatrix = o.create()),
              (this._invProjMatrix = o.create()),
              (this._frustum = [
          ...
          n(r),
            ...
            (r.prototype._update = function (t) {
              ...
              if (
                !(u(h) && u(c) && u(p) && u(d) && u(f) && u(m) && u(v) && u(_))
              )
                throw new Error("Bad view - suspect a broken limiter");
              (this._yaw = h),
                (this._pitch = c),
            ...
            (r.prototype._normalizeCoordinates = function (t) {
              return (
                "yaw" in t &&
                  (t.yaw = h(t.yaw - Math.PI, -2 * Math.PI) + Math.PI),
                "pitch" in t &&
                  (t.pitch = h(t.pitch - Math.PI, -2 * Math.PI) + Math.PI),
                "roll" in t &&
                  (t.roll = h(t.roll - Math.PI, -2 * Math.PI) + Math.PI),
                t
              );
            }),
            (r.prototype.normalizeToClosest = function (t, e) {
              ...
              Math.abs(s - i) < Math.abs(n - i)
                ? (n = s)
                : Math.abs(a - i) < Math.abs(n - i) && (n = a);
              var l = o - 2 * Math.PI,
                h = o + 2 * Math.PI;
              return (
                Math.abs(l - r) < Math.abs(o - r)
                  ? (o = l)
                  : Math.abs(l - r) < Math.abs(o - r) && (o = h),
                (e = e || {}),
                (e.yaw = n),
                (e.pitch = o),
                e
              ...
              if (this._projectionChanged) {
                ...
                if (0 !== u || 0 !== c) {
                  var p = Math.atan(2 * u * Math.tan(a / 2)),
                    ...
                    f = this._fovs;
                  (f.leftDegrees = (180 * (a / 2 + p)) / Math.PI),
                    (f.rightDegrees = (180 * (a / 2 - p)) / Math.PI),
                    (f.upDegrees = (180 * (s / 2 + d)) / Math.PI),
                    (f.downDegrees = (180 * (s / 2 - d)) / Math.PI),
                    o.perspectiveFromFieldOfView(t, f, -1, 1);
                } else o.perspective(t, s, h, -1, 1);
                o.rotateZ(t, t, this._roll),
                  o.rotateX(t, t, this._pitch),
                  o.rotateY(t, t, this._yaw),
                  o.invert(e, t),
                  this._matrixToFrustum(t, i),
                  (this._projectionChanged = !1);
              }
            }),
            (r.prototype._matrixToFrustum = function (t, e) {
              s.set(e[0], t[3] + t[0], t[7] + t[4], t[11] + t[8], 0),
                s.set(e[1], t[3] - t[0], t[7] - t[4], t[11] - t[8], 0),
                s.set(e[2], t[3] + t[1], t[7] + t[5], t[11] + t[9], 0),
                s.set(e[3], t[3] - t[1], t[7] - t[5], t[11] - t[9], 0),
                s.set(e[4], t[3] + t[2], t[7] + t[6], t[11] + t[10], 0);
            }),
            (r.prototype.projection = function () {
              return this._updateProjection(), this._projMatrix;
            }),
            ...
            (r.prototype.intersects = function (t) {
              this._updateProjection();
              for (
                var e = this._frustum, i = this._tmpVec, r = 0;
                r < e.length;
                r++
              ) {
            ...
            (r.prototype.selectLevel = function (t) {
              for (
                var e = a() * this._height,
                  i = Math.tan(0.5 * this._fov),
                  r = 0;
                r < t.length;
                r++
              ) {
            ...
            (r.prototype.screenToCoordinates = function (t, e) {
              ...
              return (
                ...
                (e.pitch = Math.acos(i[1] / l) - Math.PI / 2),
                this._normalizeCoordinates(e),
                e
              );
            }),
            (r.prototype.coordinatesToPerspectiveTransform = function (
              t,
              e,
              i
            ) {
              ...
              var r = this._height,
                ...
                a = "";
              return (
                (a += "translateX(" + p(n / 2) + "px) "),
                (a += "translateY(" + p(r / 2) + "px) "),
                (a += "translateX(-50%) translateY(-50%) "),
                (a += "perspective(" + p(s) + "px) "),
                (a += "translateZ(" + p(s) + "px) "),
                (a += "rotateZ(" + p(-this._roll) + "rad) "),
                (a += "rotateX(" + p(-this._pitch) + "rad) "),
                (a += "rotateY(" + p(this._yaw) + "rad) "),
                (a += "rotateY(" + p(-t.yaw) + "rad) "),
                (a += "rotateX(" + p(t.pitch) + "rad) "),
                (a += "translateZ(" + p(-e) + "px) "),
                (a += i + " ")
              );
            }),
            (r.limit = {
              ...
              traditional: function (t, e, i) {
                return (
                  (i = null != i ? i : e),
                  d(
                    r.limit.resolution(t),
                    r.limit.vfov(0, e),
                    r.limit.hfov(0, i),
                    r.limit.pitch(-Math.PI / 2, Math.PI / 2)
                  )
                );
              },
            }),
            (r.type = r.prototype.type = "rectilinear"),
            (e.exports = r);
        },
        {
          "../util/clamp": 89,
